...
ProvONE\footnote{http://vcvcomputing.com/provone/provone.html} integrated the work of Missier et al.'s D-PROV, Costa et al.'s and Belhajjame et al.'s Wf4ever. It is designed to serve the scientific workflow community, so it has workflow specific concepts such as \emph{Ports} and \emph{Channels}. Figure~\ref{fig:provone} shows the major concepts defined in the ProvONE ontology.
\begin{figure}
	\centering
