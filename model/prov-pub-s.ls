...
ontologies which force the users to accept them, unless
these dependencies are absolutely beneficial to the users.
We just provide suggestions in documentation and let the
users decide whether to accept the suggested dependencies.
